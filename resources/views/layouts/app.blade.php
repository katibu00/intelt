...
<head>
    ...
    <title>@yield('PageTitle') - {{ $institution->name }}</title>
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</span><span class="user-status">{{ Auth::user()->usertype }}</span></div><span class="avatar"><img class="round" @if(Auth::user()->image == 'default.png') src="/uploads/default.png" @else src="/uploads/{{$institution->username}}/avatars/{{Auth::user()->image}}" @endif alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2021<a class="ms-25" href="#" target="_blank">{{ $institution->name }}</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span><span class="float-md-end d-none d-md-block">IntelliSAS 1.0</span></p>
    </footer>
    ...
    <!-- BEGIN: Page JS-->
    <script src="/backend/app-assets/js/scripts/forms/form-select2.js"></script>
    <!-- END: Page JS-->
