...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        ...
        <div class="modal-body px-sm-5 mx-50 pb-5">
            <h2 class="text-center mb-1" id="addNewCardTitle">Add New {{$title_singular}}</h2>
           
            <div id="error_list"><ul ></ul></div>
            <!-- form -->
            <form class="row gy-1 gx-2 mt-75">
                <div class="col-12">
                    <label class="form-label" for="modalAddCardNumber">{{ $title_singular }} Name</label>
                    <input id="name" class="form-control" type="text" placeholder="{{ $title_singular }} Name"  />
                </div>
