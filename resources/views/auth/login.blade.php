...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index.html" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1">IntelT</h2>
                                </a>

                                <h4 class="card-title mb-1">Welcome to IntelT! 👋</h4>
                                <p class="card-text mb-2">Please sign-in to your account</p>
                                <ul id="error_list"></ul>
                                <form class="auth-login-form mt-2">
                                    <div class="mb-1">
                                        <label for="login-email" class="form-label">Email</label>
                                        <input type="text" class="form-control" id="login-email" placeholder="john@example.com" aria-describedby="login-email" tabindex="1" autofocus />
                                    </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge" id="login-password" tabindex="2" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="login-password" />
                                    ...
                                    <button class="btn btn-primary w-100 login_btn" tabindex="4">
                                       Login
                                    </button>
                                </form>
    ...
    <!-- BEGIN: Page JS-->
    <script src="/backend/app-assets/js/scripts/pages/auth-login.js"></script>
    <!-- END: Page JS-->
    ...
    $(document).ready(function () {
        $(document).on('click','.login_btn', function(e){
            ...
            var data = {
             ...
             spinner = '<div class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></div><span class="ms-25 align-middle"> Login...</span>';
            ...
            $.ajax({
               ...
               success: function(response){
                    ...
                    if(response.status == 200){
                        ...
                        $('#error_list').addClass('alert alert-success px-2 py-1');
                        $('#error_list').append('<li>Login Successful. Redirecting to Dashboard. . .</li>');
                        ...
                        if(response.user == 'student'){
                            window.location.replace('{{ route('student.home') }}');
                        }
                    }
                }
            });
