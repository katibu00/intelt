        ...
        <div class="content-wrapper container-xxl p-0">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-2 my-25">
                            ...
                            <div class="d-flex">
                                <a href="#" class="me-25">
                                    <img src="/backend/app-assets/images/portrait/small/avatar-s-11.jpg" id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profile image" height="100" width="100" />
                                </a>
                            ...
                            <form class="validate-form mt-2 pt-50">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        <label class="form-label" for="accountFirstName">Admission Set</label>
                                        <h5>Umar Katibu</h5>
                                    </div>
